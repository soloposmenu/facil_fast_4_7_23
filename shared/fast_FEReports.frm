...
Begin VB.Form fast_FEReports 
   ...
   Begin VB.PictureBox Picture 
      Height          =   375
      Left            =   11280
      Picture         =   "fast_FEReports.frx":0442
      ScaleHeight     =   315
      ScaleWidth      =   315
      TabIndex        =   12
      Top             =   1640
   ...
   Begin DDSharpGridOLEDB2.SGGrid DD_PEDDETALLE 
      ...
      StylesCollection=   $"fast_FEReports.frx":0A18
      ColumnsCollection=   $"fast_FEReports.frx":284B
      ValueItems      =   $"fast_FEReports.frx":31C1
   End
   ...
   Begin DDSharpGridOLEDB2.SGGrid DDCONTENIDO 
      ...
      OutlineIcons    =   1
      CellTipsDisplayLength=   3000
      StylesCollection=   $"fast_FEReports.frx":3261
      ColumnsCollection=   $"fast_FEReports.frx":5093
      ValueItems      =   $"fast_FEReports.frx":5A09
   End
   ...
   End
End
Attribute VB_Name = "fast_FEReports"
...
If dF1 = "" Then
    ...
    cSQL = cSQL & " ORDER BY DOC_SOLO DESC"
Else
    cSQL = "SELECT DOC_SOLO AS FACTURA, FORMAT(FECHA,'####-##-##') as FECHA, HORA, "
    cSQL = cSQL & " FORMAT((SUB_TOTAL + ITBM),'STANDARD') AS VALOR, FISCAL, ID_URL"
    cSQL = cSQL & " FROM TRANSAC_FISCAL "
...
cSQL = cSQL & " AND LEFT(TIPO,2) NOT IN ('VO','BV','BE','EC') "
...
Public Function Load_FE_Transac(nNumFactura As Long) As Boolean
Dim cSQL As String
Set rsFETrans = New ADODB.Recordset
...
' Author    : hsequeira
' Date      : 03/11/2024
' Purpose   : ENVIA A FE LA NC, HACE EL COPY DEL FILE, LA MONTA EN EL REGISTRY
Rem LUEGO LA IMPRIME (2 COPIAS)
'---------------------------------------------------------------------------------------
'
...
Else
    ...
    If Public_TestRequest(cNewSource, "NC", cmdAplicaNC.Tag) Then
        ProgBar.value = 70
...
' Author    : hsequeira
' Date      : 03/11/2024
' Purpose   : SE Aï¿½ADE PARA QUE EL REPORTE Z LO PUEDA CONTABILIZAR
...
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Date & Space(2) & Time & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "=================================" & vbCrLf
...
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Space(9) & "FACTURA ORIGINAL # " & lbFactura.Caption & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "eMail: " & LCase(Me.txtEmail) & vbCrLf
If bCopia Then
    Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Space(14) & "<< COPIA LOCAL >>" & vbCrLf
End If
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Chr(&HD) & Chr(&HA)
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "=================================" & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, rs00!DESCRIP & vbCrLf
'INFO: NO SALIA LA RAZON SOCIAL EN LOS REPORTES
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, rs00!RAZ_SOC & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "RUC:" & rs00!ruc & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "SERIAL:" & rs00!SERIAL & vbCrLf
    
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Space(3) & vbCrLf

Sys_Pos.Coptr1.PrintNormal PtrSReceipt, "CUFE: " & FE_CUFE & vbCrLf
Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Space(3) & vbCrLf
...
Do While Not rsLAST.EOF
    Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Format(Left(rsLAST!DESCRIP, 15), "!@@@@@@@@@@@@@@@") & Space(2) & _
...
Do While Not rsLAST_Pago.EOF
    Sys_Pos.Coptr1.PrintNormal PtrSReceipt, Format(Left(rsLAST_Pago!DESCRIP, 15), "!@@@@@@@@@@@@@@@") & Space(2) & _
